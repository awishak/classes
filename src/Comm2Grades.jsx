...
export const DEFAULT_ASSIGNMENTS = [
  ...
  { id: "teach_class", name: "Teach the Class", weight: 5, due: "", link: "", notes: "" },
  { id: "contribution", name: "Contribution Summary", weight: 10, due: "", link: "", notes: "" },
];
...
async function saveData(data) { try { const STORAGE_KEY = "comm2-v1"; await window.storage.set(STORAGE_KEY, JSON.stringify(data), true); return true; } catch { return false; } }
