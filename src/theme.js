...
// (Grades.jsx, GameSystem.jsx, etc.). Single source of truth for the theme
// system. Three themes: "clean" (default), "locked" (bold confident),
// "crashing" (Y2K maximalist). Per-class, per-user, persisted in localStorage.
