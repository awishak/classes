    ...
    <div style={{ padding: "20px 20px 40px", fontFamily: themedHeadingFont(theme, F) }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ ...crd, padding: 16, marginBottom: 16 }}>
          ...
          {showShelf && (
            <QuestionPicker storageKey={comm118cfg.storageKey} mode="free"
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ ...crd, padding: 14, marginBottom: 16, background: "#fafafa" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8, flexWrap: "wrap", gap: 6 }}>
            ...
            <button
              onClick={() => {
                const url = window.location.origin + window.location.pathname + "?presenter=" + encodeURIComponent(game.id) + "&class=comm118";
  ...
  return (
    <div style={{ padding: "20px 20px 40px", fontFamily: themedHeadingFont(theme, F) }}>
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        {picking ? (
          <QuestionPicker storageKey={comm118cfg.storageKey} mode="choice" category="on_topic"
