...
import { MyNotesView, BioView, RosterView, ReadingsView, BoardsView, ToDoView } from "./components.jsx";
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{
            ...
            padding: theme === "crashing" ? "5px 12px" : "4px 10px",
            borderRadius: 8,
            ...
            letterSpacing: theme === "locked" ? "0.04em" : "-0.005em",
        ...
        <div style={{ maxWidth: 360, width: "100%" }}>
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            <div style={{ width: 56, height: 56, borderRadius: 14, background: ACCENT, display: "inline-flex", alignItems: "center", justifyContent: "center", marginBottom: 12 }}>
              <span style={{ color: "#fff", fontSize: 16, fontWeight: 700 }}>118</span>
            </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fafaf9", color: TEXT_PRIMARY, fontFamily: F, padding: "60px 20px 40px" }}>
      <div style={{ maxWidth: 420, width: "100%", margin: "0 auto" }}>
        {/* Centered plain-text header with class identity icon */}
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <div style={{ width: 56, height: 56, borderRadius: 14, background: ACCENT, display: "inline-flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
            <span style={{ color: "#fff", fontSize: 16, fontWeight: 700, letterSpacing: "-0.02em" }}>118</span>
          </div>
          <div style={{ fontSize: 10, fontWeight: 700, color: ACCENT, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 6 }}>COMM 118 · Spring 2026</div>
          <div style={{ fontSize: 24, fontWeight: 600, color: TEXT_PRIMARY, letterSpacing: "-0.02em", lineHeight: 1.15 }}>Communication and Sport</div>
          <div style={{ fontSize: 13, color: TEXT_SECONDARY, marginTop: 6 }}>MWF 8:00 to 9:05 am · Vari 128</div>
        </div>
