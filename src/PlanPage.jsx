...
const SESSIONS = [
  {
    ...
    groups: [
      ...
      { name: "Then, in the same session", items: [
        ["Every note about a day, on the dashboard", "Notes were being written in two editors and landing in three fields, and the dashboard read one of them. The Scratch Pad is now the Notes panel and stacks all of it: the week's lesson plan and its free text, both written in the Schedule editor and until now visible nowhere near the room, then the day note from Day Plan, then the box I scribble in during class. Each written one has an Edit link back to where it came from."],
