...
const SESSIONS = [
  {
    ...
    groups: [
      ...
      { name: "Then, in the same session", items: [
        ["The name of the thing comes first", "A row in a section had its kind badge to the left of the title, a truncated URL underneath, and the buttons on a line of their own. Now the name gets the left edge to itself and everything else follows it on the same line: what kind of thing it is, Open, To the room, Headline. Kind and actions are answers to questions I only ask after reading the name, so they come after it. The subtitle is gone entirely, and so is every caller computing one for it."],
