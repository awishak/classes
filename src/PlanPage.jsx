...
const SESSIONS = [
  {
    ...
    groups: [
      ...
      { name: "Then, in the same session", items: [
        ["Merge two sections", "Next to New section. Pick any two and it says which way round it will go before doing it \u2014 whichever sits higher up the day keeps its name, the other empties into it and goes. Picking them in the wrong order still merges the right way, because the order is read off the day rather than off the two dropdowns."],
