...
function RosterView({ data, setData, userName }) {
  ...
  if (selectedId) {
    ...
    return <BioView student={student} data={data} setData={setData} userName={userName} onBack={() => setSelectedId(null)} storageKey={STORAGE_KEY} saveData={saveData} uploadPhoto={uploadPhoto} bioFields={BIO_FIELDS} teamColors={TEAM_COLORS} favTeamLabel="Research Motto" />;
  }
