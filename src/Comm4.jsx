...
function HomeView({ data, setData, userName, isAdmin, setView }) {
  ...
  // Theme-aware card style. Returns the style object for a card given its index.
      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        {me && (
          <div style={{ marginBottom: 32 }}>
            ...
            <BioView student={me} data={data} setData={setData} userName={userName} onBack={null} storageKey={STORAGE_KEY} saveData={saveData} uploadPhoto={uploadPhoto} bioFields={BIO_FIELDS} teamColors={TEAM_COLORS} favTeamLabel="Research Motto" />
          </div>
        )}
...
export default function Comm4() {
  ...
  if (!userName) return <NamePicker data={data} onSelect={name => { setUserName(name); setView(name === GUEST_NAME ? "schedule" : "home"); }} storageKey={STORAGE_KEY} allStudents={ALL_STUDENTS} accent={ACCENT} adminPin="118711" lastSort={lastSort} iconText="4" iconFontSize={18} courseCode="COMM 4 · Spring 2026" courseTitle="Approaches to Communication Research" meetingInfo="MWF 11:45 am to 12:50 pm · Lucas 207" />;
...
function ThemedComm4Wrapper({ data, isAdmin, isGuest, view, setView, displayName, testStudent, setTestStudent, setStudentView, studentView, setUserName, effectiveUserName, effectiveAdmin, activitiesLive, visibleStudents, setData }) {
  ...
  return (
    ...
    >
      ...
      {view === "todo" && !isGuest && <ToDoView data={data} setData={setData} userName={effectiveUserName} isAdmin={effectiveAdmin} storageKey={STORAGE_KEY} saveData={saveData} accent={ACCENT} lastSortObj={lastSortObj} />}
