...
const STUDENTS = [
  ...
  { src: "s-anon", phone: true, title: "Students can ask me anything, anonymously if they want",
    body: ["There's a QR code on the room screen. Scan the code, type the question, and tick the box if you'd rather I didn't know who's asking. The question lands on my dashboard during class and I answer out loud. Nobody has to raise a hand in front of 30 people."] },
  { src: "s-poll", phone: true, title: "Students vote, then we argue, then they vote again",
    body: ["I put a question on the screen. Everybody commits to an answer on their phone before anyone talks. Then they argue with the person next to them and vote a second time, and the room screen shows what moved. That second vote is the whole point."] },
  { src: "s-board", phone: true, title: "The whole class answers the same prompt at once",
    body: ["I cast a prompt to the room screen. Every student answers on their phone, and every answer shows up on every phone. Quiet students write more than they'd ever say out loud, and I can read the room in about a minute."] },
  { src: "s-deck", phone: true, title: "Grades arrive as a card, with a note from me",
    body: ["When I release grades, each student gets a deck of cards the next time they open the site: the grade, what the grade means, and my comment. One card at a time, tap through, done. The same deck tells a student when a challenge is due in the next 48 hours."] },
  { src: "s-schedule", phone: true, title: "Every reading is one tap away",
    body: ["Every week, every reading, with the link. Drew's Picks are the ones I'd read first. Students stop asking me what's due Wednesday, because the answer is on their phone."] },
  { src: "s-challenges", phone: true, title: "Every challenge shows its weight",
    body: ["Every assignment on one screen, with its due date and how much of the grade it carries. Sit-Down 1 is worth 15% and Weekly Challenge 2 is worth 2.5%, and a student can see that before deciding which one gets tonight."] },
];
...
const TEACHERS = [
  { src: "t-dashboard", title: "I teach from one screen",
    body: ["The day plan on the left, in sections with minutes. The room screen preview on the right, with Next. The shelf underneath: every reading and activity for the term, searchable. I press Next and the next thing goes on the projector."] },
  { src: "t-room-poll", title: "The projector is a page I control from my laptop",
    body: ["Whatever I cast goes up: a prompt, a poll, a reading, a slide, a question a student just asked. Every screen carries the QR code, so a student who walks in late can join from the door."] },
  { src: "t-grade", title: "Grading is sorting cards into columns",
    body: ["I'm tired of deciding between a 91 and a 93. Did you do the work? Did you do the work well? A grade is a column, and a column is a word. I drag every card, then I release the whole class at once. Nothing reaches a student until I press Release."] },
  { src: "t-bulk", title: "I can change 40 things at once",
  ...
  { src: "t-horn", title: "Around the Horn is a seating chart I can tap",
    body: ["Drag names into seats. Tap a seat to award points. The points go into the same log the leaderboard reads, so speaking up in class counts for something a student can see."] },
  { src: "sp-presenter", title: "We play games in class, with the scoreboard on the projector",
