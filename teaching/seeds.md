...
Small stories, examples, and hooks that are fun to talk about. Each seed is tagged by the **concept** it teaches and the **class** it serves, so you can pull the right one when building a lecture.

## How to add a seed

Copy the template block below. **Concept** and **Class** are the two fields that matter most. Slot type tells you where it fits in a [sequence](sequences.md). Source is so you can recall or cite it later.

Slot vocabulary: `connect` `explain` (past · present · future) `move` `example` (see [README](README.md)).

```
### <short memorable title>
- **Concept:** <tag, e.g. triangulation>
- **Class:** <Comm 118 / Comm 2 / Comm 4 / any>
- **Slot:** <connect / explain / move / example>
- **Source:** <where it came from>

<the hook itself, in a sentence or two. End with the turn: what concept it lands.>
```
...
- **Class:** any
- **Slot:** connect, explain, move
- **Source:** Ira Glass on creative work

Show this every class. Ira Glass: when you start out, your taste is good but your work isn't there yet. There's a gap between what you can make and what you know is good, and that gap is what makes everyone want to quit. The turn: the only way to close it is volume. Do a lot of work, on a deadline, and your ability catches up to your taste. Frame the whole class as a machine for closing that gap.

### Bam Adebayo's 83-point game
- **Concept:** stakes / scarcity-of-spectacle
- **Class:** any
- **Slot:** connect, explain
- **Source:** Bam Adebayo 83-pt game

An 83-point game in a meaningless game was a farce, and yet more entertaining than a normal game. So if no-stakes spectacle is better, why not make every game some other game? The turn: the farce is entertaining *because* it's rare. Make it the format and the novelty burns off, the baseline just moves, and you've kept none of the magic. The exception lives off the rule. Entertainment is borrowed against a backdrop of stakes you didn't pay for in that moment, and you can't print more of it. Same in communication: stakes are what make a message legible, and the break in the format is what carries the signal.

### Choose your question (easy / challenging / nerd)
- **Concept:** self-assessment / differentiated close
- **Class:** any
- **Slot:** move
